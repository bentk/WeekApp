...
namespace WeekCalendarTest
{
    ...
    public class CalendarTests
    {
        ...
        {
            var weekNo = new WeekCalendar.Week().GetWeekNumberFromDate(new DateTime(2011, 1, 1));
        ...
        {
            var weekNumber = new WeekCalendar.Week().GetWeekNumberFromDate(new DateTime(2012, 12, 31));
        ...
        {
            var weekNumber = new WeekCalendar.Week().GetWeekNumberFromDate(new DateTime(2012, 02, 29));
        ...
        {
            var daysInCurrentWeek = new WeekCalendar.Week().GetDaysInCurrentWeek(new DateTime(2012, 9, 12));
