...
namespace WeekNumber
{
    ...
    // {
    //     WeekNumber.SearchResultsPage.Activate(args.QueryText, args.PreviousExecutionState);
    // }
    /// <summary>
    /// This page displays search results when a global search is directed to this application.
    /// </summary>
    public sealed partial class SearchResultsPage : WeekNumber.Common.LayoutAwarePage
    {
        ...
        public static void Activate(String queryText)
        {
            ...
            else
            {
                ...
                var page = new SearchResultsPage{_previousContent = previousContent };
            ...
            frame.Navigate(typeof (GroupedItemsPage), queryText);
        }
        ...
        /// </summary>
        private sealed class Filter : WeekNumber.Common.BindableBase
        {
